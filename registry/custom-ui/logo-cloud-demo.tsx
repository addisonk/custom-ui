...
const iconClassName = "h-9 w-auto max-w-[7rem] text-foreground";

const logos: LogoCloudItem[] = [
  {
    name: "GitHub",
    logo: <GithubLogo aria-label="GitHub" className={iconClassName} />,
  },
  {
    name: "Vercel",
    logo: <VercelLogo aria-label="Vercel" className={iconClassName} />,
  },
  {
    name: "OpenAI",
    logo: <OpenAILogo aria-label="OpenAI" className={iconClassName} />,
  },
  {
    name: "Cursor",
    logo: <CursorLogo aria-label="Cursor" className={iconClassName} />,
  },
  {
    name: "React",
    logo: <ReactLogo aria-label="React" className={iconClassName} />,
  },
  {
    name: "shadcn/ui",
    logo: <ShadcnLogo aria-label="shadcn/ui" className={iconClassName} />,
  },
  {
    name: "Expo",
    logo: <ExpoLogo aria-label="Expo" className={iconClassName} />,
  },
  {
    name: "Astro",
    logo: <AstroLogo aria-label="Astro" className={iconClassName} />,
  },
  {
    name: "Linear",
    logo: <LinearLogo aria-label="Linear" className={iconClassName} />,
  },
  {
    name: "Supabase",
    logo: <SupabaseLogo aria-label="Supabase" className={iconClassName} />,
  },
  {
    name: "Clerk",
    logo: <ClerkLogo aria-label="Clerk" className={iconClassName} />,
  },
  {
    name: "Figma",
    logo: <FigmaLogo aria-label="Figma" className={iconClassName} />,
  },
];
...
function ReactLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 256 228" fill="none">
      <ellipse
        cx="128"
        cy="114"
        rx="110"
      ...
      />
      <circle cx="128" cy="114" r="18" fill="currentColor" />
    </svg>
  );
}

function ShadcnLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 256 256" fill="none">
      <path
        ...
        strokeLinecap="round"
        strokeWidth="25"
        d="M208 128l-80 80M192 40 40 192"
      />
    </svg>
  );
}

function ExpoLogo(props: SVGProps<SVGSVGElement>) {
  return (
...
function AstroLogo(props: SVGProps<SVGSVGElement>) {
  return (
...
function SupabaseLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 109 113" fill="none">
      ...
      <path
        fill="currentColor"
        d="M45.317 2.071c2.86-3.601 8.658-1.628 8.726 2.97l.442 67.251H9.831c-8.19 0-12.759-9.46-7.665-15.874L45.317 2.071Z"
      />
    </svg>
  );
}
...
function ClerkLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} fill="none" viewBox="0 0 128 128">
      ...
      <path
        fill="currentColor"
        d="M99.572 10.788c1.999 1.34 2.17 4.156.468 5.858L85.424 31.262c-1.32 1.32-3.37 1.53-5.033.678A35.846 35.846 0 0 0 64 28c-19.882 0-36 16.118-36 36a35.846 35.846 0 0 0 3.94 16.391c.851 1.663.643 3.712-.678 5.033L16.646 100.04c-1.702 1.702-4.519 1.531-5.858-.468C3.974 89.399 0 77.163 0 64 0 28.654 28.654 0 64 0c13.163 0 25.399 3.974 35.572 10.788ZM100.04 111.354c1.702 1.702 1.531 4.519-.468 5.858C89.399 124.026 77.164 128 64 128c-13.164 0-25.399-3.974-35.572-10.788-2-1.339-2.17-4.156-.468-5.858l14.615-14.616c1.322-1.32 3.37-1.53 5.033-.678A35.847 35.847 0 0 0 64 100a35.846 35.846 0 0 0 16.392-3.94c1.662-.852 3.712-.643 5.032.678l14.616 14.616Z"
      />
    </svg>
  );
}
...
function FigmaLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 54 80" fill="none">
      <path
        fill="currentColor"
        d="M13.333 80c7.36 0 13.334-5.973 13.334-13.333V53.333H13.333C5.973 53.333 0 59.307 0 66.667 0 74.027 5.973 80 13.333 80ZM0 40c0-7.36 5.973-13.333 13.333-13.333h13.334v26.666H13.333C5.973 53.333 0 47.36 0 40ZM0 13.333C0 5.973 5.973 0 13.333 0h13.334v26.667H13.333C5.973 26.667 0 20.693 0 13.333ZM26.667 0H40c7.36 0 13.333 5.973 13.333 13.333S47.36 26.667 40 26.667H26.667V0ZM53.333 40c0 7.36-5.973 13.333-13.333 13.333S26.667 47.36 26.667 40 32.64 26.667 40 26.667 53.333 32.64 53.333 40Z"
      />
    </svg>
  );
}
